...
class HUD(avango.script.Script):
    ...
    def my_constructor(self, SCENE, CAMERA_TANSFORM, PLAYERID):
        ...
        self.label0 = self.create_text(avango.osg.Vec3((-(0.12 + 0.015)), gl_physical_screen_height * 0.44, 0.0), "Runde:");
        self.text0 = self.create_text(avango.osg.Vec3((-(0.08)), gl_physical_screen_height * 0.44, 0.0), "1/3");
        self.label1 = self.create_text(avango.osg.Vec3((-(0.12 + 0.015)), gl_physical_screen_height * 0.41, 0.0), "Position:");
        self.text1 = self.create_text(avango.osg.Vec3((-(0.08)), gl_physical_screen_height * 0.41, 0.0), "1/2");
        self.label2 = self.create_text(avango.osg.Vec3( (0.005), gl_physical_screen_height * 0.44, 0.0), "Zeit:");
        self.text2 = self.create_text(avango.osg.Vec3(((0.085)), gl_physical_screen_height * 0.44, 0.0), "00:00:000");
        self.label3 = self.create_text(avango.osg.Vec3((0.005), gl_physical_screen_height * 0.41, 0.0), "Rundenzeit:");
        self.text3 = self.create_text(avango.osg.Vec3(((0.085)), gl_physical_screen_height * 0.41, 0.0), "--:--:---");
