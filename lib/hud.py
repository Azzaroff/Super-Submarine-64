...
class HUD(avango.script.Script):
    ...
    def my_constructor(self, SCENE, CAMERA_TANSFORM, PLAYERID):
        ...
        #self.hud_transform.Matrix.value *= avango.osg.make_trans_mat(.0, 2.0, 15.0)
        ...
        #if self.id == 0:
        #    self.Scene.Player0.group.Children.value.append(self.hud_transform)
        #else:
        #    self.Scene.Player1.group.Children.value.append(self.hud_transform)
    ...
    def change_text(self, textid,new_content):
        ...
        print self.hud_transform.Matrix.value
